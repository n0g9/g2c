...
:root {
  ...
  --app-bg: var(--main-alt);
  --app-watermark-one: "NOG";
  --app-watermark-two: "LABUBU";
...
.card__73069 .icon-1fWS75 {
  margin: 16px !important;
}
.card__73069 .icon-1fWS75 + .flexChild__7c0ba {
  margin-inline-start: 0;
}
...
.info__6436f, .infoText-1-X8oU, .info_e3f97f {
  background-color: hsl(var(--accent-hsl), 0.1);
  border-radius: var(--card-radius-big);
  border-color: hsl(var(--accent-hsl--material-you));
}
.info__6436f .icon__6436f, .infoText-1-X8oU .icon__6436f, .info_e3f97f .icon__6436f {
  color: hsl(var(--accent-hsl--material-you));
}
...
.addFriendInputWrapper__72ba7 .addFriendInput__72ba7::-webkit-input-placeholder,
.addFriendInputWrapper__72ba7 .addFriendHint__72ba7::-webkit-input-placeholder {
  color: var(--text-muted);
  font-weight: 500;
}
.addFriendInputWrapper__72ba7 .addFriendInput__72ba7 {
...
.authBoxExpanded__921c5 .info__6436f, .authBoxExpanded__921c5 .infoText-1-X8oU, .authBoxExpanded__921c5 .info_e3f97f {
  border-radius: var(--card-radius-big);
}
 ...
 *
 */
.addGamePopout__497cd {
  background-color: var(--popout-color) !important;
  border-radius: var(--popout-radius-big) !important;
  border: none !important;
  box-shadow: var(--shadow-medium) !important;
}
.addGamePopout__497cd .lookLink__201d5 {
  margin-inline-end: 8px;
}
...
.recentMentionsPopout__95796 .wrapper_c19a55.cozy_c19a55 {
  overflow: visible;
}
.messagesPopoutWrap_e8b59c .wrapper_c19a55.cozy_c19a55:before, .messagesPopoutWrap_e8b59c .wrapper_c19a55.cozy_c19a55:after,
.recentMentionsPopout__95796 .wrapper_c19a55.cozy_c19a55:before,
.recentMentionsPopout__95796 .wrapper_c19a55.cozy_c19a55:after {
  display: none;
}
.messagesPopoutWrap_e8b59c .wrapper_c19a55.cozy_c19a55 .avatar_c19a55,
.recentMentionsPopout__95796 .wrapper_c19a55.cozy_c19a55 .avatar_c19a55 {
  inset-inline-start: -50px;
}
.messagesPopoutWrap_e8b59c .wrapper_c19a55.cozy_c19a55 .container_b7e1cb,
.recentMentionsPopout__95796 .wrapper_c19a55.cozy_c19a55 .container_b7e1cb {
  overflow: hidden;
}

.recentMentionsPopout__95796 .scrollerBase_d125d2 {
...
body:active .recentMentionsPopout__95796:not(:active) {
  opacity: 0;
  transition: 150ms ease all;
}
...
.messages__0e467 li:first-child .message__5126c {
  border-start-start-radius: var(--message-radius);
  border-start-end-radius: var(--message-radius);
}
.messages__0e467 li:first-child .message__5126c:before, .messages__0e467 li:first-child .message__5126c:after {
  display: none;
}
...
.actionMenuButton__12cd0 {
  background-color: transparent;
  border-radius: 50%;
  transition: var(--default-time) var(--default-animation) background-color;
}
.actionMenuButton__12cd0:hover {
  background-color: var(--card-button-color);
}
.actionMenuButton__12cd0[aria-expanded=true] {
  background-color: var(--card-button-color-hover);
}

.appDetailsContainer__24605 .appDetailsSection__24605 {
  border-block-start: none;
  border-block-end: none;
}
.appDetailsContainer__24605 .collapseable__217b7 {
  margin-block-end: 8px;
  padding: 16px;
  background-color: var(--card-color-hover);
  border-radius: var(--card-radius-big);
...
.appDetailsContainer__24605 .collapseable__217b7:active {
  background-color: var(--card-color-hover) !important;
}
...
.accountButtonInner__4109d:hover {
  background-color: var(--card-button-color-hover);
}
...
.connection__4109d .connectionHeader__4109d {
  margin-block-end: 0;
  padding: 16px;
  background-color: transparent;
  font-size: 1.25em;
...
.connection__4109d .connectionOptions__4109d {
  padding-block: 0 var(--space-16);
  padding-inline: var(--space-16);
}
.connection__4109d .connectionOptions__4109d .connectionOptionSwitch__4109d {
  padding-inline-start: 0;
  padding-inline-end: 0;
}
.connection__4109d .connectionOptions__4109d .connectionOptionSwitch__4109d:last-of-type {
  margin-block-end: 0;
}
.connection__4109d .divider_ae36e5 {
  margin: 0 var(--space-16);
  border-top-color: var(--card-border-color);
}
.connection__4109d .metadataContainer__4109d, .connection__4109d .container_f652ac {
  --card-color-filled: var(--card-color-alt);
...
.connection__4109d .upsellWrapper__4109d {
  padding: 0;
}
.connection__4109d .container_f652ac .button__201d5 {
  min-width: 130px;
}
.connection__4109d .container__35859 {
  width: auto;
  margin-block: var(--space-8) var(--space-16);
  margin-inline: var(--space-16);
}

.integrationWrapper__4109d {
  padding: 0;
  background-color: transparent;
}
.integrationWrapper__4109d .integration__4109d {
  --card-color-filled: var(--card-color-alt);
  background-color: var(--card-color-filled);
  border: none;
  padding: var(--space-16);
...
.integrationWrapper__4109d .integration__4109d:first-of-type {
  border-radius: var(--card-radius-big) var(--card-radius-big) 4px 4px;
}
.integrationWrapper__4109d .integration__4109d:last-of-type {
  border-radius: 4px 4px var(--card-radius-big) var(--card-radius-big);
}
.integrationWrapper__4109d .integration__4109d:only-child {
  border-radius: calc(var(--card-radius-big) / 1.6);
}
.integrationWrapper__4109d .integration__4109d .button__201d5 {
  background-color: hsl(var(--accent-hsl), 0.1);
  color: hsl(var(--accent-hsl--material-you));
}
...
.header__5cea9 .text-md\/semibold_cf4812 {
  font-size: 1em;
  font-weight: 400;
}
...
.usersList__5cea9 .row__5cea9 {
  padding: 12px 8px;
  border-radius: calc(var(--card-radius-big) / 1.65);
  border-block-end: none;
  transition: var(--default-time) var(--default-animation) background-color;
}
.usersList__5cea9 .row__5cea9:hover {
  background-color: var(--card-color-hover);
}
...
.loadMoreButton__5cea9:hover {
  background-color: var(--card-button-color-hover);
}
.loadMoreButton__5cea9 .text-sm\/semibold_cf4812 {
  font-weight: 400;
}
 ...
 *
 */
.sessions__803f2 .fieldset__7fb92 .stack_dbd263 {
  background-color: var(--card-color-filled) !important;
  border: none !important;
...
.session__803f2:last-of-type:before {
  height: calc(100% - 8px);
}
.session__803f2:hover:before {
  opacity: 1;
}
.session__803f2 .sessionIcon__803f2,
.session__803f2 .sessionInfo__803f2,
.session__803f2 .sessionMoreButton__803f2 {
  z-index: 2;
}
.session__803f2 .sessionIcon__803f2 {
  background-color: hsl(var(--accent-hsl--material-you));
...
.session__803f2 .sessionInfoRow__803f2:not(.eyebrow_e5a66c) {
  color: var(--text-muted);
}
.session__803f2 .sessionInfoRow__803f2 .lookLink__201d5 {
  --button-height: 20px;
  padding: 0 4px;
}
.session__803f2 .eyebrow_e5a66c {
  font-size: 14px;
  text-transform: none;
}
.session__803f2 .sessionSeparator__803f2 {
  display: none;
}
 ...
 *
 */
.overlayEnabledSettingsContainer__9d98d .collapseable__217b7 {
  padding: 0;
  border-block-start: none;
}
.overlayEnabledSettingsContainer__9d98d .groupContainer__9d98d {
  border-radius: var(--card-radius-big);
}
 ...
 *
 */
.accountProfileCard_a27e58 {
  background-color: var(--card-color-filled);
  border-radius: var(--card-radius-big);
}
.accountProfileCard_a27e58 .banner__68edb {
  border-radius: var(--card-radius-big);
}
.accountProfileCard_a27e58 .userInfo_a27e58 {
  position: relative;
  height: 88px;
  padding: 16px 16px 16px 130px;
}
.accountProfileCard_a27e58 .userInfo_a27e58 .wrapper__44b0c {
...
.accountProfileCard_a27e58 .userInfo_a27e58 .wrapper__44b0c .mask__44b0c {
  position: relative;
  width: 90px;
  height: 90px;
}
.accountProfileCard_a27e58 .userInfo_a27e58 .wrapper__44b0c .avatarDecoration__44b0c {
  transform: translate(-2px);
}
.accountProfileCard_a27e58 .mask__68edb circle {
  display: none;
}
.accountProfileCard_a27e58 .background_a27e58 {
  padding: var(--space-16);
  background-color: var(--card-color-hover);
  border-radius: calc(var(--popout-radius-big) / 1.6);
}
.accountProfileCard_a27e58 .background_a27e58 .constrainedRow_a27e58 .button__201d5 {
  margin-inline-start: 8px;
}
.accountProfileCard_a27e58 .background_a27e58 .button__201d5:not(:last-child) {
  margin-inline-end: 16px;
}
.accountProfileCard_a27e58 .badgeList_a27e58 {
  height: 32px;
  padding: 0 8px;
  background-color: var(--card-color-hover) !important;
  border-radius: 16px;
...
/* USER SETTINGS -> NITRO -> SERVER BOOST */
.gradient_d81f48 {
  border-radius: var(--card-radius-big);
}
...
.notDetected__497cd .gameName__497cd {
  color: var(--interactive-text-default) !important;
}
.notDetected__497cd .lastPlayed__497cd {
  color: var(--text-muted) !important;
}
...
.nowPlaying__497cd .flowerStar__3e3b0 path {
  fill: #fff;
}
.nowPlaying__497cd .childContainer__3e3b0 path {
  fill: #000;
}

.nowPlayingAdd__497cd {
  margin: 16px 0;
  color: var(--interactive-text-default) !important;
}
.nowPlayingAdd__497cd .lookLink__201d5 {
  margin-inline-start: 8px;
}
.nowPlayingAdd__497cd + .marginTop40_fd297e {
  margin-block-start: 0;
}

.addedGamesTitle__497cd {
  margin-block-end: 0;
  padding: 16px;
  background-color: transparent;
  font-size: 1.25em;
...
.game__497cd.hoverCardNoMargin__497cd:before {
  inset-inline-start: var(--space-8);
  inset-inline-end: var(--space-4);
}
.game__497cd:first-of-type {
  padding-block-start: var(--space-24);
  border-radius: var(--card-radius-big) var(--card-radius-big) 0 0;
}
.game__497cd:first-of-type:before {
  height: calc(100% - 8px);
  inset-block-start: 8px;
}
.game__497cd:last-of-type {
  padding-block-end: var(--space-24);
  border-radius: 0 0 var(--card-radius-big) var(--card-radius-big);
  box-shadow: none !important;
}
.game__497cd:last-of-type:before {
  height: calc(100% - 8px);
  inset-block-end: 8px;
}
.game__497cd:before {
...
.game__497cd .gameName__497cd {
  font-weight: 500;
}
.game__497cd:hover .gameNameInput__497cd {
  background-color: var(--input-color-alt);
}
.game__497cd:hover:before {
  opacity: 1;
}
.game__497cd:focus-within:before {
  opacity: 1;
}
.game__497cd .gameNameInput__497cd {
  margin-inline-start: -4px;
  padding: 0 4px;
  border: none;
  border-radius: 12px;
...
.game__497cd .gameNameInput__497cd:hover, .game__497cd .gameNameInput__497cd:focus {
  background-color: var(--input-color-alt);
}
.game__497cd .overlayStatusText__668e1 {
  color: var(--text-muted) !important;
}
.game__497cd .button__9a406 {
  inset-inline-end: -12px;
}
.game__497cd .removeGame__497cd {
  inset-block-start: calc(var(--space-8) * -1);
  inset-inline-end: 0;
}
...
.cardWrapper_aae012 .card__11580, .cardWrapper_aae012 .card_aae012 {
  border-radius: var(--card-radius-big);
}
...
.appliedBoostContainer_f9ed30 {
  padding-block-end: 16px;
  background-color: var(--card-color-filled);
  border-radius: var(--card-radius-big);
}

.boostContainer_f9ed30 {
  margin-inline-start: var(--space-16);
  margin-inline-end: var(--space-16);
  padding: var(--space-8) var(--space-16);
  background-color: var(--card-color-hover);
}
.boostContainer_f9ed30:nth-of-type(2) {
  border-start-start-radius: calc(var(--card-radius-big) / 1.75);
  border-start-end-radius: calc(var(--card-radius-big) / 1.75);
}
.boostContainer_f9ed30:last-of-type {
  border-end-start-radius: calc(var(--card-radius-big) / 1.75);
  border-end-end-radius: calc(var(--card-radius-big) / 1.75);
}

.boostContainerSeparator_f9ed30 {
  display: none;
}
...
.guild__74638 .guildHeader__30707 {
  background-color: transparent;
  border-block-end: 1px solid var(--card-border-color);
}
...
.guildSubscriptionSlots__5823d .guildSubscriptionSlot_b76fc6 {
  padding: 16px;
  position: relative;
  border-block-end: none;
}
.guildSubscriptionSlots__5823d .guildSubscriptionSlot_b76fc6:after {
  position: absolute;
  content: " ";
  width: calc(100% - 16px * 2);
  height: 1px;
...
.guildSubscriptionSlots__5823d .guildSubscriptionSlot_b76fc6:last-of-type:after {
  display: none;
}
...
.wrapper__5b98e .heading__5b98e {
  font-weight: 400;
}
.wrapper__5b98e .list__5b98e {
  border-block-start: none;
}
.wrapper__5b98e .listItem__5b98e {
  border-bottom-color: var(--card-border-color);
}
.wrapper__5b98e .listItem__5b98e:last-child {
  border-block-end: none;
}
